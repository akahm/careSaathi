...
import { Phone, Heart, ArrowRight, CheckCircle, Truck, Users, Stethoscope, HeartHandshake, Building2 } from "lucide-react"
  ...
  return (
    <DialogContent className="max-w-2xl">
      <div className="space-y-6">
        ...
        <Button className="w-full bg-gradient-to-r from-red-500 to-blue-500 text-white">Get This Service</Button>
      </div>
    </DialogContent>
  )
}
...
export default function CTASection() {
  ...
  return (
    <AnimatedSection className="py-16 sm:py-15 lg:py-10 relative overflow-hidden">
      ...
      <div className="relative container mx-auto px-1 text-center bg-transparent">
        <motion.div
          ...
          viewport={{ once: true }}
          className="max-w-5xl mx-auto space-y-6 sm:space-y-8 lg:space-y-10"
        >
          ...
          <p className="text-base sm:text-lg lg:text-xl xl:text-2xl text-slate-600 dark:text-slate-300 leading-relaxed max-w-4xl mx-auto">
            You can't be everywhere at once. But with CareSaathi — you'll never feel far. Join thousands of families
            who trust us with their most precious relationships.
          </p>
  ...
  className="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white px-8 sm:px-12 py-4 sm:py-6 text-base sm:text-lg lg:text-xl shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105"
/>

            <Button
              size="lg"
              variant="outline"
              className="border-2 border-blue-500 text-blue-600 dark:text-blue-400 hover:bg-gradient-to-r hover:from-blue-50 hover:to-blue-100 dark:hover:from-blue-950 dark:hover:to-blue-900 px-8 sm:px-12 py-4 sm:py-6 text-base sm:text-lg lg:text-xl shadow-xl hover:shadow-2xl transition-all duration-300"
            >
