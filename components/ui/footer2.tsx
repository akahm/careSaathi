        ...
        <footer className="relative bg-gradient-to-br from-blue-900 to-red-900 text-white overflow-hidden">
            ...
            <div className="relative px-4 py-6">
                <div className="container mx-auto text-center">
                    ...
                    {/* Footer Links Grid */}
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-4 text-left max-w-6xl mx-auto">
                        {/* Main Pages */}
                        <div>
                        ...
                        <div>
                            ...
                            {/* Email */}
                            <div className="flex items-center space-x-3 text-slate-300 mb-3 justify-start">
                                <a
                    ...
                    <motion.div
                        ...
                        className="border-t border-red-700 pt-2 flex flex-col md:flex-row justify-between items-center text-slate-400 text-sm"
                    >
                        <p className=" ">
