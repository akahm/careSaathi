  ...
  return (
    ...
    >
      ...
      <section className="pt-12 pb-4 text-center">
        <Badge className="bg-gradient-to-r from-blue-100 to-red-100 text-blue-800 px-4 py-2">📋 Legal Terms</Badge>
        ...
        <p className="text-lg text-slate-600 dark:text-slate-300 mt-2">
          Effective Date: 16-06-2025 | Last Updated: 16-06-2025
        </p>
      </section>
        ...
        <div className="container mx-auto px-4">
          <Alert className="max-w-4xl mx-auto border-red-200 bg-red-50 dark:bg-red-900/30 dark:border-red-700">
            ...
            <AlertDescription className="text-red-700 dark:text-red-300">
              <strong>Important:</strong> CareSaathi is not a hospital or emergency medical provider. Always dial 108 in emergencies.
            </AlertDescription>
          </Alert>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 max-w-4xl space-y-8">
          {[
            ...
            <Card key={i} className="bg-card text-card-foreground border border-border shadow-md">
              <CardHeader>
